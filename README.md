...
1. Создать новую таблицу "Недолжники", имеющую одно поле <a href="#">account_id</a> (айди счета). 
   ...
   - алгоритм получения интересующего айди:
     ...
     ```
2. Провести фильтрацию и обработку данных из указанных таблиц. Убедиться, что мусорные (с ошибочными данными в полях - данные других полей, бессмысленная символика, логические ошибки и т.д.) и ненужные (содержащие пустые поля) данные, а также дубли (строки таблицы, содержащие информацию идентичную другой в данной таблице) не попадут в новую таблицу.
